function [time, states, commands] = simulate_unicycle_neighbor_only_delay(...
    A, initial_states, tau, T, dt, gain, k_v, k_theta, ...
    use_saturation, v_max, omega_max, allow_backward_motion)
%SIMULATE_UNICYCLE_NEIGHBOR_ONLY_DELAY
%
% Neighbor-only delayed unicycle rendezvous.
%
% The desired planar velocity is:
%   U(t) = -gain * D * P(t) + gain * A * P(t - tau)
