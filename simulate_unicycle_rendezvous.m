function [time, states, commands] = simulate_unicycle_rendezvous(L, initial_states, tau, T, dt, gain, k_v, k_theta, use_saturation, v_max, omega_max, allow_backward_motion)
%SIMULATE_UNICYCLE_RENDEZVOUS Kinematic unicycle tracking delayed consensus velocity.
